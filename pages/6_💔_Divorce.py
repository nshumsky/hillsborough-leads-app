...
DISPLAY = [c for c in [
    ...
    'party_1_name', 'party_2_name', 'address_street', 'address_city', 'address_state', 'address_zip',
...
RENAME = {
    ...
    'address_street': 'Address', 'address_city': 'City', 'address_state': 'State', 'address_zip': 'ZIP',
